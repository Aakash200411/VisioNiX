    ...
    <div className="min-h-screen bg-light">
      ...
      <div className="bg-white border-b border-border shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-dark">Extraction Results</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {extractions.length === 0 ? (
          <div className="bg-white rounded-lg border border-border p-12 text-center">
            <h2 className="text-xl font-semibold text-dark mb-2">No Extractions Yet</h2>
            <p className="text-gray-500 mb-4">
              Upload images in the chat to see extraction results here.
            </p>
            <button
              onClick={() => navigate('/chat')}
              className="inline-flex items-center gap-2 px-6 py-2 bg-primary text-white rounded-lg hover:bg-secondary transition-colors"
            >
              Go to Chat
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg border border-border p-4 sticky top-20">
                <h2 className="font-semibold text-dark mb-4">Analyzed Images</h2>
                <p className="text-xs text-gray-500 mb-4">{extractions.length} extraction(s)</p>
